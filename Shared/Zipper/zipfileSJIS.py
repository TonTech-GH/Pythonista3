...
# ==================================
# ZIPファイルの展開(Shift-JIS)対応版
# 標準のzipfileモジュールはファイル名がUTF-8とCP437にしか対応していない。
# Windowsの標準機能でZIP圧縮するとファイル名がShift-JISになるためzipfileで解凍すると文字化けする。
# このモジュールでは文字化け解消のため、ファイル名をShift-JIS(CP932)で扱うようになっている。
# ==================================
# ----------------------------------
# import module
# ----------------------------------
